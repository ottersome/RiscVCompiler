...
typedef struct Attributes{
    ...
    //This may or may not suit in the union, but cant care less
    unsigned char addressInStack;//Address in case it is a variable (or a function even???)
} Attributes;
...
struct SymbolTable{//We will be using the hash table used in the book
    ...
    SymbolTableEntry* scopeDisplay[HASH_TABLE_SIZE];
...
void closeScope(SymbolTable *,SymbolTableEntry * entryForClosingMethod,Node* assocNode,size_t* tabIndex);
